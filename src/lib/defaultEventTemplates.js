...
export const DEFAULT_TEMPLATES = [
  ...
  },
  {
    ...
    "description": "跨天的回山活動使用，適合有的精舍每天分開發車、出發回程時間不同的情況。已預設開啟「多日交通安排」，建立活動後請到「活動設定」補填實際的起訖日期並存檔，報名表單就會自動出現「參加日期」「是否掛單」欄位，排車頁也會依日期分別安排。既有的「是否掛單」「掛單開始/結束日期」欄位是給寮房資料匯入比對用，跟這次新的「參加日期」機制是兩件事，都保留、不衝突。",
    "location": "中台禪寺",
    "location_tag": "zhongtai",
    "event_type": "mountain",
    "is_dharma": false,
