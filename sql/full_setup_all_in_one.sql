...
-- ------------------------------------------------------------
-- [90/90] add_other_date_bucket.sql（2026-08-10 追加，排車其他日期分頁＋分時段彈性選項）
-- ------------------------------------------------------------
-- 分時段彈性選項：events.up_slot_options／down_slot_options 改後台可勾選，NULL=沿用舊寫死預設。
-- 「其他日期」分頁：car_assignments.is_other_date 標記（service_date 固定 NULL，不分時段/大小車）。
-- 跨分頁手動 override：新表 registration_bucket_overrides。只套用到之後使用此功能的活動。
...
-- ------------------------------------------------------------
-- [91/91] add_evening_down_slot.sql（2026-08-12 追加，分時段回程新增「晚上」選項）
-- ------------------------------------------------------------
