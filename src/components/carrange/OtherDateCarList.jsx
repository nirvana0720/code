    ...
    <section>
      ...
      <div className="space-y-3">
        {cars.length === 0 ? (
          ...
          cars.map((car, ci) => (
            <div key={car.tempId} className="bg-white border rounded-xl shadow-sm overflow-visible">
              <div className="flex items-center gap-3 px-4 py-3 bg-indigo-100 border-b-2 border-indigo-300 rounded-t-xl">
                <input
                  value={car.car_name}
              ...
              <div className="px-4 py-2.5 bg-gray-50 border-t border-gray-100 rounded-b-xl">
                <SearchableSelect
                  value=""
